    ...
    subjects: [
      {
        ...
        topics: [
          ...
          { name: 'Partnership' },
          { name: 'Corporation (C-Corp and S-Corp)' },
          { name: 'Limited Liability Company (LLC)' },
          { name: 'Nonprofit Organizations' },
          { name: 'Marketing Fundamentals' },
          { name: 'The Four Ps of Marketing (Product, Price, Place, Promotion)' },
          { name: 'Market Research and Analysis' },
          { name: 'Target Market and Customer Segmentation' },
          { name: 'Brand Development and Management' },
          { name: 'Digital Marketing Basics' },
          { name: 'Social Media Marketing' },
          { name: 'Content Marketing' },
          { name: 'Finance and Accounting Basics' },
          { name: 'Financial Statements (Balance Sheet, Income Statement, Cash Flow)' },
          { name: 'Assets, Liabilities, and Equity' },
          ...
          { name: 'Startup Funding and Venture Capital' },
      ...
      },
      {
        ...
        topics: [
          ...
          { name: 'Journal Entries and General Ledger' },
          { name: 'T-Accounts' },
          { name: 'Trial Balance' },
          ...
          { name: 'Profitability Ratios (ROI, ROE, Profit Margin)' },
          { name: 'Leverage Ratios (Debt-to-Equity)' },
          { name: 'Cost Accounting Basics' },
          { name: 'Fixed vs Variable Costs' },
          { name: 'Depreciation Methods' },
          { name: 'Inventory Valuation (FIFO, LIFO, Weighted Average)' },
          { name: 'Accounts Payable and Receivable' },
          { name: 'Payroll Accounting' },
          { name: 'Tax Accounting Basics' },
          { name: 'Internal Controls and Fraud Prevention' },
          { name: 'Auditing Fundamentals' },
          { name: 'GAAP Principles' },
      ...
      },
      {
        ...
        topics: [
          ...
          { name: 'Targeting and Positioning' },
          { name: 'Competitive Analysis' },
          { name: 'SWOT Analysis' },
          { name: 'Porter\'s Five Forces' },
          { name: 'Value Proposition Development' },
          { name: 'Consumer Behavior' },
          { name: 'Buyer Decision Process' },
          { name: 'Psychological Factors in Marketing' },
          { name: 'Brand Equity and Loyalty' },
          { name: 'Product Development and Lifecycle' },
          { name: 'Pricing Strategies' },
          { name: 'Distribution Channels' },
          { name: 'Integrated Marketing Communications' },
          { name: 'Advertising Fundamentals' },
      ...
      {
        name: 'Finance',
        description: 'Investment, capital management, and financial planning',
        topics: [
          { name: 'Time Value of Money' },
          { name: 'Present Value and Future Value' },
          { name: 'Annuities and Perpetuities' },
          ...
          { name: 'Leverage and Financial Risk' },
          { name: 'Working Capital Management' },
          { name: 'Corporate Financing Options' },
          ...
          { name: 'Bankruptcy and Restructuring' },
      ...
      },
      {
        ...
        topics: [
          ...
          { name: 'Creating a Personal Budget' },
          ...
          { name: 'Debt Repayment Strategies (Snowball vs Avalanche)' },
          { name: 'Student Loans' },
          { name: 'Mortgage Basics' },
          { name: 'Good Debt vs Bad Debt' },
          { name: 'Investing Basics (Stocks, Bonds)' },
          { name: 'Types of Investment Accounts (Brokerage, IRA, 401k)' },
          { name: 'Asset Allocation' },
          { name: 'Index Funds and ETFs' },
          { name: 'Mutual Funds' },
          { name: 'Real Estate Investing' },
          { name: 'Risk Tolerance and Investment Strategy' },
          { name: 'Dollar-Cost Averaging' },
          { name: 'Compound Interest and Wealth Building' },
          { name: 'Taxes and Income' },
          { name: 'Understanding Tax Brackets' },
          { name: 'Tax Deductions and Credits' },
          { name: 'W-2 vs 1099 Income' },
          { name: 'Tax-Advantaged Accounts' },
          { name: 'Filing Your Tax Return' },
          { name: 'Retirement Planning' },
          { name: 'Retirement Accounts (401k, IRA, Roth IRA)' },
          { name: 'Social Security Benefits' },
          { name: 'Retirement Savings Calculations' },
          { name: 'Insurance Basics (Health, Life, Auto, Home)' },
      ...
      },
      {
        ...
        description: 'Organizational behavior and team leadership',
        topics: [
          { name: 'Management Fundamentals' },
          { name: 'Planning, Organizing, Leading, and Controlling' },
          ...
          { name: 'Motivation Theories (Maslow, Herzberg, McGregor)' },
      ...
      {
        name: 'Business Law',
        description: 'Legal principles in business operations',
        topics: [
          { name: 'Introduction to Business Law' },
          { name: 'Contract Law Basics' },
          { name: 'Elements of a Valid Contract' },
          { name: 'Breach of Contract' },
          { name: 'Contract Remedies' },
          { name: 'Tort Law' },
          { name: 'Negligence and Liability' },
          { name: 'Product Liability' },
          { name: 'Intellectual Property' },
          { name: 'Patents, Trademarks, and Copyrights' },
          { name: 'Trade Secrets' },
          { name: 'Employment Law' },
          { name: 'Hiring and Termination' },
          { name: 'Workplace Discrimination' },
          { name: 'Wage and Hour Laws' },
          { name: 'Employee vs Independent Contractor' },
          { name: 'Corporate Governance' },
          { name: 'Shareholder Rights' },
          { name: 'Board of Directors Duties' },
          { name: 'Securities Regulation' },
          { name: 'Consumer Protection Laws' },
          { name: 'Privacy and Data Protection' },
          { name: 'Antitrust and Competition Law' },
      ...
      },
      {
        ...
        description: 'Economic principles applied to business decisions',
        topics: [
          { name: 'Supply and Demand in Business Context' },
          { name: 'Price Elasticity and Pricing Decisions' },
          { name: 'Market Structures and Competition' },
          { name: 'Perfect Competition' },
          { name: 'Monopolistic Competition' },
          { name: 'Oligopoly' },
          { name: 'Monopoly' },
          { name: 'Cost Analysis for Business' },
          { name: 'Marginal Cost and Marginal Revenue' },
          { name: 'Economies of Scale' },
          { name: 'Production Functions' },
          { name: 'Market Failure and Externalities' },
          { name: 'Public Goods and Business' },
          { name: 'Macroeconomic Indicators for Business' },
          { name: 'GDP and Economic Growth' },
          { name: 'Inflation and Deflation' },
          { name: 'Interest Rates and Business Investment' },
          { name: 'Unemployment and Labor Markets' },
          { name: 'Business Cycles' },
          { name: 'Fiscal Policy Impact on Business' },
          { name: 'Monetary Policy Impact on Business' },
          { name: 'International Trade and Business' },
          { name: 'Exchange Rates and Currency Risk' },
          { name: 'Globalization and Business Strategy' }
        ]
      },
      {
        ...
        topics: [
          ...
          { name: 'Hypothesis Testing in Business' },
          ...
          { name: 'HR Analytics' },
          { name: 'Excel for Business Analytics' },
          { name: 'SQL for Business Queries' },
          { name: 'Introduction to Tableau/Power BI' }
        ]
      },
      {
        ...
        topics: [
          ...
          { name: 'Productivity Tools and Apps' },
          ...
          { name: 'Continuing Education and Certifications' },
      ...
      },
      {
        ...
        description: 'Managing production and distribution',
        topics: [
          ...
          { name: 'Six Sigma and Quality Control' },
          { name: 'Process Improvement' },
          { name: 'Capacity Planning' },
          { name: 'Global Supply Chain Management' },
          { name: 'Supply Chain Risk Management' },
          { name: 'Technology in Supply Chain' },
          { name: 'Sustainability in Operations' }
        ]
      }
    ]
  }

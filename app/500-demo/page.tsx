    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-white">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-soft-xl p-8 md:p-12 text-center">
        ...
        <p className="text-lg text-neutral-600 mb-8">
          We&apos;re experiencing technical difficulties. Our team is working on it. Please try again in a few moments.
        </p>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-xs text-neutral-500 mt-2">
            Check system status or contact support if the problem persists.
          </p>
        </div>
      </div>
    </div>
